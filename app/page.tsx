...
/* âââ Glass Card Style ââââââââââââââââââââââââââââââââââââââââââââââââââââ */
...
/* âââ Portfolio Images âââââââââââââââââââââââââââââââââââââââââââââââââââââ */
const PORTFOLIO = [
  ...
  { file:'1000010712.jpg', label:'OmbrÃ© Colour',       span:1 },
...
/* âââ Particle Canvas ââââââââââââââââââââââââââââââââââââââââââââââââââââââ */
    ...
    <section id="hero" style={{ position:'relative', minHeight:'92vh', display:'flex', flexDirection:'column', alignItems:'center', justifyContent:'center', overflow:'hidden', background:'radial-gradient(at 20% 50%, rgba(139,92,246,0.18) 0%, transparent 60%), radial-gradient(at 80% 20%, rgba(13,148,136,0.12) 0%, transparent 50%), #1e1e2e', padding:'0 1.5rem 3rem' }}>
      ...
      <div style={{ position:'relative', zIndex:1, textAlign:'center', maxWidth:800, paddingTop:80 }}>
        <div style={{ display:'inline-flex', alignItems:'center', gap:8, background:'rgba(139,92,246,0.12)', border:'1px solid rgba(139,92,246,0.30)', borderRadius:999, padding:'0.35rem 1rem', marginBottom:'1.5rem', ...raleway, fontSize:'0.75rem', fontWeight:600, letterSpacing:'0.12em', color:C.tealL, textTransform:'uppercase' }}>
          Amherstview Â· Kingston, Ontario
        </div>
        ...
        <p style={{ ...raleway, fontSize:'clamp(1rem,2vw,1.125rem)', color:'rgba(240,234,248,0.75)', maxWidth:560, margin:'0 auto 2.5rem', lineHeight:1.7 }}>
          25+ years of Goldwell-certified colour mastery, bespoke cuts, and luxury extension installations. Private studio in Amherstview â and mobile care that comes to you.
        </p>
        ...
        <div style={{ display:'flex', justifyContent:'center', gap:'clamp(1.5rem,4vw,3.5rem)', flexWrap:'wrap' }}>
          {[['25+','Years Experience'],['â­ 5.0','Client Rating'],['Goldwell','Certified Colourist'],['Mobile','Care Available']].map(([val,sub]) => (
...
/* âââ Coming Soon Banner âââââââââââââââââââââââââââââââââââââââââââââââââââ */
function ComingSoon() {
  return (
    <div style={{ background:'linear-gradient(90deg,rgba(229,184,105,0.08),rgba(229,184,105,0.14),rgba(229,184,105,0.08))', borderTop:'1px solid rgba(229,184,105,0.20)', borderBottom:'1px solid rgba(229,184,105,0.20)', padding:'1rem 2rem', display:'flex', justifyContent:'center', alignItems:'center', gap:'1rem', backdropFilter:'blur(8px)', WebkitBackdropFilter:'blur(8px)' }}>
      <span style={{ fontSize:'1.3rem' }}>ðï¸</span>
      <div>
        ...
        <span style={{ ...raleway, fontSize:'0.95rem', color:C.white, fontWeight:500, marginLeft:12 }}>Dedicated Garage Salon Transformation â Amherstview, Ontario</span>
      </div>
...
const SERVICES = [
  { icon:'âï¸',  title:'Precision Cuts',           desc:'Sculpted bobs, textured layers, and custom shapes tailored to your face and lifestyle.', price:'From $60', style:glassCard },
  { icon:'ð¨',  title:'Balayage & Colour',         desc:'Hand-painted sun-kissed tones, rich glosses, and dimensional highlights.', price:'From $120', style:glassCard },
  { icon:'â¨',  title:'Vivid & Creative Colour',   desc:'Bold fantasy colours â from pastel lavender to deep ocean teal â expertly formulated.', price:'Custom Quote', style:glassCard },
  { icon:'ð',  title:'Bridal & Special Occasion', desc:'Bespoke wedding hair and event styling with pearl pins, braids, and elegant updos.', price:'From $150', style:glassCard },
  { icon:'ð ',  title:'Mobile Concierge',          desc:'Emily comes to your home, retirement residence, or facility. Full service, zero travel stress.', price:'Call for Quote', style:glassCard },
  { icon:'ð§',  title:"Men\'s Grooming",           desc:'Precision fades, textured crops, and classic barbershop-style cuts for all hair types.', price:'From $35', style:glassCard },
];
...
/* âââ Goldwell Suite âââââââââââââââââââââââââââââââââââââââââââââââââââââââ */
  ...
  return (
    <section id="goldwell" style={{ padding:'5rem 1.5rem', background:'#1e1e2e', borderTop:'1px solid rgba(229,184,105,0.12)' }}>
      <div style={{ maxWidth:1100, margin:'0 auto' }}>
        <p style={{ ...raleway, textAlign:'center', fontSize:'0.75rem', fontWeight:700, letterSpacing:'0.15em', color:C.gold, textTransform:'uppercase', marginBottom:'0.75rem' }}>â¦ Premium Offerings â¦</p>
        ...
        <div style={{ display:'grid', gridTemplateColumns:'repeat(auto-fit,minmax(380px,1fr))', gap:'2rem' }}>
          <div style={{ ...goldCard, padding:'2.5rem', transition:'transform 0.2s, box-shadow 0.2s' }}
            ...
            <div style={{ display:'flex', alignItems:'center', gap:'1rem', marginBottom:'1.5rem' }}>
              <div style={{ width:56, height:56, borderRadius:14, background:'rgba(229,184,105,0.15)', backdropFilter:'blur(8px)', WebkitBackdropFilter:'blur(8px)', border:'1px solid rgba(229,184,105,0.30)', display:'flex', alignItems:'center', justifyContent:'center', fontSize:'1.8rem' }}>ð</div>
              <div>
            ...
            <p style={{ ...raleway, color:C.gray, lineHeight:1.75, marginBottom:'1.5rem' }}>Emily holds Goldwell Colour Mastery certification â the highest level of colour artistry training in the professional hair industry. Every formula is precision-mixed for your unique hair history, porosity, and goal.</p>
            <ul style={{ listStyle:'none', padding:0, margin:'0 0 1.8rem', display:'flex', flexDirection:'column', gap:'0.5rem' }}>
              {['Balayage & foil work','Full colour transformation','Vivid fashion shades','Grey blending & toning','Gloss treatments'].map(item => (
                <li key={item} style={{ ...raleway, color:C.gray, fontSize:'0.9rem', display:'flex', alignItems:'center', gap:8 }}>
                  <span style={{ color:C.tealL, fontSize:'0.85rem' }}>â</span> {item}
                </li>
              ))}
            </ul>
          ...
          <div style={{ ...goldCard, padding:'2.5rem', transition:'transform 0.2s, box-shadow 0.2s' }}
            ...
            onMouseLeave={e => { (e.currentTarget as HTMLElement).style.transform=''; (e.currentTarget as HTMLElement).style.boxShadow=''; }}>
            <div style={{ display:'flex', alignItems:'center', gap:'1rem', marginBottom:'1.5rem' }}>
              <div style={{ width:56, height:56, borderRadius:14, background:'rgba(139,92,246,0.15)', backdropFilter:'blur(8px)', WebkitBackdropFilter:'blur(8px)', border:'1px solid rgba(139,92,246,0.30)', display:'flex', alignItems:'center', justifyContent:'center', fontSize:'1.8rem' }}>ð</div>
              <div>
            ...
            <p style={{ ...raleway, color:C.gray, lineHeight:1.75, marginBottom:'1.5rem' }}>Seamlessly blended, damage-free extension installations using premium Goldwell-aligned hair. From subtle length to dramatic volume â each strand is colour-matched and bonded with precision.</p>
            <ul style={{ listStyle:'none', padding:0, margin:'0 0 1.8rem', display:'flex', flexDirection:'column', gap:'0.5rem' }}>
  ...
  return (
    <section id="gallery" style={{ padding:'5rem 1.5rem', background:'linear-gradient(180deg,rgba(30,30,46,1) 0%,rgba(20,20,35,1) 100%)' }}>
      <div style={{ maxWidth:1200, margin:'0 auto' }}>
        ...
        <h2 style={{ ...fenway, textAlign:'center', fontSize:'clamp(2rem,5vw,3rem)', color:C.white, marginBottom:'0.75rem', fontWeight:700 }}>â From Our Chair: Real Transformations â</h2>
        ...
        <div style={{ display:'grid', gridTemplateColumns:'repeat(3,1fr)', gap:'1rem' }}>
          {PORTFOLIO.map((img, i) => (
            <div key={img.file} style={{ gridColumn: img.span === 2 ? 'span 2' : 'span 1', borderRadius:16, overflow:'hidden', cursor:'pointer', position:'relative', aspectRatio:'16/10', transition:'transform 0.2s, box-shadow 0.2s' }}
              ...
              onMouseLeave={e => { (e.currentTarget as HTMLElement).style.transform=''; (e.currentTarget as HTMLElement).style.boxShadow=''; }}>
              <Image src={"/images/" + img.file} alt={img.label + " â by Emily Caird, Amherstview Ontario"} fill style={{ objectFit:'cover' }} sizes="(max-width:768px) 100vw, 40vw" />
      ...
      {lightbox !== null && (
        <div style={{ position:'fixed', inset:0, background:'rgba(0,0,0,0.92)', zIndex:1000, display:'flex', alignItems:'center', justifyContent:'center', backdropFilter:'blur(8px)', WebkitBackdropFilter:'blur(8px)' }} onClick={() => setLightbox(null)}>
          <button onClick={e => { e.stopPropagation(); setLightbox((lightbox-1+PORTFOLIO.length)%PORTFOLIO.length); }} style={{ position:'absolute', left:16, background:'rgba(255,255,255,0.12)', border:'none', color:'#fff', fontSize:'2rem', cursor:'pointer', padding:'0.5rem 1rem', borderRadius:12, backdropFilter:'blur(8px)', WebkitBackdropFilter:'blur(8px)' }}>â</button>
          ...
          <button onClick={e => { e.stopPropagation(); setLightbox((lightbox+1)%PORTFOLIO.length); }} style={{ position:'absolute', right:16, background:'rgba(255,255,255,0.12)', border:'none', color:'#fff', fontSize:'2rem', cursor:'pointer', padding:'0.5rem 1rem', borderRadius:12, backdropFilter:'blur(8px)', WebkitBackdropFilter:'blur(8px)' }}>â</button>
          <button onClick={() => setLightbox(null)} style={{ position:'absolute', top:16, right:16, background:'rgba(255,255,255,0.12)', border:'none', color:'#fff', fontSize:'1.5rem', cursor:'pointer', padding:'0.4rem 0.8rem', borderRadius:10, backdropFilter:'blur(8px)', WebkitBackdropFilter:'blur(8px)' }}>â</button>
          <div style={{ position:'absolute', bottom:24, left:'50%', transform:'translateX(-50%)', ...raleway, color:'rgba(255,255,255,0.6)', fontSize:'0.8rem' }}>{lightbox+1} / {PORTFOLIO.length} â {PORTFOLIO[lightbox].label}</div>
        </div>
      )}
    </section>
  );
...
/* âââ About Emily ââââââââââââââââââââââââââââââââââââââââââââââââââââââââââ */
/* âââ About Emily ââââââââââââââââââââââââââââââââââââââââââââââââââââââââââ */
function AboutEmily() {
  return (
      ...
      <div style={{ maxWidth:1100, margin:'0 auto', display:'grid', gridTemplateColumns:'1fr 1fr', gap:'4rem', alignItems:'center' }}>
        <div style={{ position:'relative' }}>
          <div style={{ borderRadius:24, overflow:'hidden', position:'relative', boxShadow:'0 24px 80px rgba(139,92,246,0.25)', aspectRatio:'4/5' }}>
            <img src="/images/1000011101.jpg" alt="Emily Caird â Master Colourist, Amherstview Ontario" style={{ width:'100%', height:'100%', objectFit:'cover', objectPosition:'center top', display:'block' }} />
        ...
        <div>
          ...
          <p style={{ ...raleway, color:C.gray, lineHeight:1.8, marginBottom:'1rem' }}>With over 25 years of hands-on experience in colour artistry and hair design, Emily brings Goldwell-certified mastery to every client â whether in her private Amherstview studio or your own home.</p>
          ...
          <div style={{ display:'grid', gridTemplateColumns:'1fr 1fr', gap:'0.75rem', marginBottom:'2rem' }}>
            {[['â¨','Private Studio'],['ð','Goldwell Certified'],['ð¿','25+ Years Expert'],['â¦','Mobile Concierge'],['âï¸','Precision Cuts'],['ð','Client-First Always']].map(([icon,label]) => (
          ...
          {TESTIMONIALS.map((t,i) => (
            <div key={i} style={{ ...glassCard, padding:'2rem', transition:'transform 0.2s' }}
              ...
              <div style={{ display:'flex', gap:3, marginBottom:'1rem' }}>
                {'âââââ'.split('').map((_,si) => <span key={si} style={{ color:C.gold, fontSize:'1.1rem' }}>â</span>)}
              </div>
...
/* âââ Mobile Concierge âââââââââââââââââââââââââââââââââââââââââââââââââââââ */
    ...
    <section id="mobile-care" style={{ padding:'5rem 1.5rem', background:'linear-gradient(135deg,rgba(13,148,136,0.06) 0%,rgba(30,30,46,1) 100%)' }}>
      <div style={{ maxWidth:1100, margin:'0 auto', display:'grid', gridTemplateColumns:'1fr 1fr', gap:'3rem', alignItems:'center' }}>
          ...
          <ul style={{ listStyle:'none', padding:0, margin:'0 0 2rem', display:'flex', flexDirection:'column', gap:'0.6rem' }}>
            {['Retirement & LTC home visits','In-home appointments','Accessible service for mobility challenges','All equipment brought on-site'].map(item => (
              <li key={item} style={{ ...raleway, color:C.gray, fontSize:'0.95rem', display:'flex', alignItems:'center', gap:10 }}>
                <span style={{ color:C.tealL }}>â</span> {item}
              </li>
            ))}
          </ul>
        ...
        <div style={{ display:'grid', gridTemplateColumns:'1fr 1fr', gap:'1rem' }}>
          {[['ð','Amherstview & Kingston, ON'],['ð','Mobile Service Available'],['ð¥','Retirement Home Visits'],['ð','(613) 929-8711']].map(([icon,label]) => (
...
/* âââ Smart Price Estimator (fixed: always starts at Q1) âââââââââââââââââââ */
const PW_STEPS = [
...
const PW_RESULTS: Record<string, { price:string; time:string; note:string }> = {
  '0-0':{ price:'From $120', time:'2â3 hrs', note:'Fresh canvas â ideal for balayage' },
  '0-1':{ price:'From $130', time:'2.5â3.5 hrs', note:'Beautiful full transformation' },
  '0-2':{ price:'From $160', time:'3â4 hrs', note:'Vivid on virgin hair is stunning' },
  '0-3':{ price:'From $60',  time:'1â1.5 hrs', note:'Precision cut with consultation' },
  '1-0':{ price:'From $120', time:'2â3 hrs', note:'Healthy hair takes colour beautifully' },
  '1-1':{ price:'From $130', time:'2.5â3.5 hrs', note:'Professional history makes this seamless' },
  '1-2':{ price:'From $150', time:'3â4 hrs', note:'Colour removal may be needed' },
  '1-3':{ price:'From $60',  time:'1â1.5 hrs', note:'Great cut, fresh start' },
  '2-0':{ price:'From $180', time:'3.5â5 hrs', note:'Box dye removal adds time & cost' },
  '2-1':{ price:'From $200', time:'4â5 hrs', note:'Full correction before new colour' },
  '2-2':{ price:'From $280', time:'4â5 hrs', note:'Colour correction required' },
  '2-3':{ price:'From $60',  time:'1â1.5 hrs', note:'Cut is always a great starting point' },
  '3-0':{ price:'From $140', time:'2.5â4 hrs', note:'Consultation included to assess' },
  '3-1':{ price:'From $150', time:'3â4 hrs', note:'Consultation included to assess' },
  '3-2':{ price:'From $170', time:'3.5â5 hrs', note:'Consultation to determine approach' },
  '3-3':{ price:'From $60',  time:'1â1.5 hrs', note:'Easy starting point â just a cut' },
};
  ...
  return (
    <section style={{ padding:'5rem 1.5rem', background:'linear-gradient(135deg,rgba(139,92,246,0.06) 0%,rgba(30,30,46,1) 100%)' }}>
      <div style={{ maxWidth:700, margin:'0 auto' }}>
        ...
        <p style={{ ...raleway, textAlign:'center', color:C.gray, marginBottom:'3rem' }}>Answer 2 quick questions â get an instant estimate</p>
...
/* âââ Vibe Setter âââââââââââââââââââââââââââââââââââââââââââââââââââââââââââ */
const VIBES = [
  { icon:'ð¿', label:'Natural & Effortless', rec:'Balayage with a lived-in finish and a soft trim' },
  { icon:'â¨', label:'Polished & Refined',   rec:'Precision cut and glossy single-process colour' },
  { icon:'ð¥', label:'Bold & Dramatic',      rec:'Vivid colour transformation + creative cut' },
  { icon:'ð¸', label:'Soft & Romantic',      rec:'Pastel tones, face-framing highlights, waves' },
  { icon:'ð¤', label:'Edgy & Modern',        rec:'Geometric cut, fashion colour, bold contrast' },
  { icon:'ð', label:'Classic Luxury',       rec:'Goldwell Suite: Colour Mastery or Extensions' },
];
  ...
  return (
    <section style={{ padding:'5rem 1.5rem', background:'#1e1e2e', borderTop:'1px solid rgba(139,92,246,0.10)' }}>
      <div style={{ maxWidth:1000, margin:'0 auto' }}>
        ...
        <p style={{ ...raleway, textAlign:'center', color:C.gray, marginBottom:'3rem' }}>Pick your aesthetic â we'll curate the perfect service for you</p>
        ...
        {selected !== null && (
          <div style={{ ...glassCard, padding:'2rem', textAlign:'center', borderColor:'rgba(139,92,246,0.50)', background:'rgba(139,92,246,0.10)' }}>
            ...
            <p style={{ ...raleway, color:C.white, fontSize:'1.15rem', fontWeight:600, marginBottom:'1.5rem' }}>â¨ {VIBES[selected].rec}</p>
...
const HOURS = [
  { day:'Monday',    open:'9:00 AM â 7:00 PM', idx:1 },
  { day:'Tuesday',   open:'9:00 AM â 7:00 PM', idx:2 },
  { day:'Wednesday', open:'9:00 AM â 7:00 PM', idx:3 },
  { day:'Thursday',  open:'9:00 AM â 8:00 PM', idx:4 },
  { day:'Friday',    open:'9:00 AM â 6:00 PM', idx:5 },
  { day:'Saturday',  open:'8:00 AM â 5:00 PM', idx:6 },
  ...
  return (
    <section id="hours" style={{ padding:'5rem 1.5rem', background:'linear-gradient(180deg,rgba(13,148,136,0.05) 0%,#1e1e2e 100%)' }}>
      <div style={{ maxWidth:700, margin:'0 auto' }}>
        ...
        <p style={{ ...raleway, textAlign:'center', color:C.gray, fontSize:'0.85rem', marginTop:'1.5rem' }}>â¦ By appointment only. Walk-ins welcome when available.</p>
      </div>
    </section>
  );
}
...
const FAQS = [
  ...
  { q:`What products do you use?`, a:`Emily exclusively uses Goldwell professional products â the same line used in top editorial and fashion settings. All formulas are custom-mixed for your unique hair.` },
  { q:`Is the studio truly private?`, a:`Yes. The studio is a dedicated private space â no other clients during your appointment. You get undivided attention for your full service.` },
...
/* âââ Booking CTA âââââââââââââââââââââââââââââââââââââââââââââââââââââââââââ */
  ...
  return (
    <section id="book-now" style={{ padding:'6rem 1.5rem', background:'linear-gradient(135deg,rgba(139,92,246,0.12) 0%,rgba(13,148,136,0.08) 50%,rgba(30,30,46,1) 100%)' }}>
      <div style={{ maxWidth:600, margin:'0 auto', textAlign:'center' }}>
        ...
        <p style={{ ...raleway, color:'rgba(229,184,105,0.80)', fontSize:'0.85rem', marginBottom:'2.5rem', fontStyle:'italic' }}>Online booking coming soon â call or text to schedule today.</p>
        <div style={{ display:'flex', gap:'1rem', justifyContent:'center', flexWrap:'wrap' }}>
...
function Footer() {
  return (
    <footer style={{ background:'#13131e', borderTop:'1px solid rgba(139,92,246,0.15)', padding:'2.5rem 1.5rem', textAlign:'center' }}>
      ...
      <p style={{ ...raleway, color:C.gray, fontSize:'0.85rem', margin:'0 0 1.5rem' }}>Emily Caird Â· Amherstview / Kingston, Ontario Â· (613) 929-8711</p>
      ...
      <p style={{ ...raleway, color:'rgba(255,255,255,0.25)', fontSize:'0.75rem', margin:0 }}>Â© 2026 The Perfect Look By Emily. All rights reserved.</p>
    </footer>
  );
}

/* âââ AI Concierge ââââââââââââââââââââââââââââââââââââââââââââââââââââââââââ */
const AI_REPLIES: Record<string, string> = {
  balayage: "Balayage starts from $120 and takes 2â3 hours. It's Emily's signature speciality â hand-painted for a natural, sun-kissed effect that grows out beautifully.",
  ...
  cut:      "Precision cuts start at $60 for 1â1.5 hrs. Emily specialises in bobs, layers, textured cuts, and anything that works with your unique face shape.",
  extension:"Extension installations are custom-quoted. Emily uses tape-in, micro-link (I-tip), and halo methods â all colour-matched and damage-free.",
  ...
  book:     "To book, call or text Emily at (613) 929-8711. A $25 deposit secures your appointment. She's open MonâWed 9â7, Thu 9â8, Fri 9â6, Sat 8â5.",
...
function AIConcierge() {
  ...
  const [msgs, setMsgs] = useState<ChatMsg[]>([{ role:'ai', text:"Hi! I'm Emily's AI assistant ð Ask me about services, pricing, booking, or mobile visits." }]);
        ...
        {open && (
          <div style={{ position:'absolute', bottom:'calc(100% + 12px)', right:0, width:360, background:'rgba(20,20,36,0.96)', backdropFilter:'blur(20px)', WebkitBackdropFilter:'blur(20px)', border:'1px solid rgba(139,92,246,0.35)', borderRadius:20, boxShadow:'0 24px 80px rgba(0,0,0,0.5)', overflow:'hidden' }}>
            <div style={{ background:'linear-gradient(135deg,#8b3cf7,#0d9488)', padding:'1rem 1.2rem', display:'flex', justifyContent:'space-between', alignItems:'center' }}>
              ...
              <button onClick={() => setOpen(false)} style={{ background:'rgba(255,255,255,0.15)', border:'none', color:'#fff', cursor:'pointer', borderRadius:8, padding:'0.3rem 0.6rem', fontSize:'1rem' }}>â</button>
            </div>
            <div style={{ height:280, overflowY:'auto', padding:'1rem', display:'flex', flexDirection:'column', gap:'0.75rem' }}>
              ...
              {typing && (
                <div style={{ display:'flex', justifyContent:'flex-start' }}>
                  <div style={{ background:'rgba(139,92,246,0.12)', border:'1px solid rgba(139,92,246,0.25)', borderRadius:'16px 16px 16px 4px', padding:'0.65rem 1rem', ...raleway, fontSize:'0.85rem', color:C.gray }}>Typingâ¦</div>
                </div>
              )}
              <div ref={bottomRef} />
            </div>
            <div style={{ padding:'0.75rem', borderTop:'1px solid rgba(139,92,246,0.15)', display:'flex', gap:'0.5rem' }}>
              <input value={input} onChange={e => setInput(e.target.value)} onKeyDown={e => e.key === 'Enter' && send()} placeholder="Ask about services, pricing, bookingâ¦" style={{ flex:1, background:'rgba(139,92,246,0.08)', border:'1px solid rgba(139,92,246,0.25)', borderRadius:12, padding:'0.65rem 0.9rem', ...raleway, color:C.white, fontSize:'0.875rem', outline:'none' }} />
              <button onClick={send} style={{ background:'linear-gradient(135deg,#8b3cf7,#7c3aed)', border:'none', borderRadius:12, padding:'0.65rem 1rem', color:'#fff', cursor:'pointer', fontSize:'1rem', flexShrink:0 }}>â</button>
            </div>
          </div>
        )}
...
function BackToTop() {
  ...
  return (
    <button onClick={() => window.scrollTo({ top:0, behavior:'smooth' })} aria-label="Back to top" style={{ position:'fixed', bottom:'5.5rem', right:'2rem', zIndex:998, width:44, height:44, borderRadius:'50%', background:'rgba(139,92,246,0.80)', backdropFilter:'blur(12px)', WebkitBackdropFilter:'blur(12px)', border:'1px solid rgba(139,92,246,0.50)', color:'#fff', fontSize:'1.1rem', cursor:'pointer', display:'flex', alignItems:'center', justifyContent:'center', boxShadow:'0 4px 16px rgba(139,92,246,0.40)', transition:'transform 0.2s, box-shadow 0.2s' }}
      onMouseEnter={e => { (e.currentTarget as HTMLElement).style.transform='translateY(-2px)'; }}
      onMouseLeave={e => { (e.currentTarget as HTMLElement).style.transform=''; }}>â</button>
  );
}

/* âââ Sticky Mobile CTA ââââââââââââââââââââââââââââââââââââââââââââââââââââ */
function StickyMobileCTA() {
  ...
  return (
    <div style={{ position:'fixed', bottom:0, left:0, right:0, zIndex:997, background:'rgba(20,20,36,0.95)', backdropFilter:'blur(16px)', WebkitBackdropFilter:'blur(16px)', borderTop:'1px solid rgba(139,92,246,0.25)', padding:'0.75rem 1.5rem', display:'flex', gap:'0.75rem', transform: visible ? 'translateY(0)' : 'translateY(100%)', transition:'transform 0.35s ease', pointerEvents: visible ? 'auto' : 'none' }}
      ...
      <a href="tel:6139298711" style={{ flex:1, background:'linear-gradient(135deg,#0d9488,#14b8a6)', color:'#fff', padding:'0.85rem', borderRadius:20, fontSize:'0.9rem', fontWeight:700, textDecoration:'none', textAlign:'center', display:'flex', alignItems:'center', justifyContent:'center', gap:6 }}>ð Call Now</a>
      <a href="sms:6139298711" style={{ flex:1, background:'rgba(139,92,246,0.80)', backdropFilter:'blur(8px)', WebkitBackdropFilter:'blur(8px)', color:'#fff', padding:'0.85rem', borderRadius:20, fontSize:'0.9rem', fontWeight:700, textDecoration:'none', textAlign:'center', display:'flex', alignItems:'center', justifyContent:'center', gap:6, border:'1px solid rgba(139,92,246,0.50)' }}>ð¬ Text Us</a>
    </div>
  );
}
...
/* âââ Schema Markup ââââââââââââââââââââââââââââââââââââââââââââââââââââââââ */
...
/* âââ Home (Main Page) âââââââââââââââââââââââââââââââââââââââââââââââââââââ */
