export default function HeroSection() {
    return (
          <section id="about" style={{
                  ...
                  <div style={{ fontSize: '12px', letterSpacing: '4px', color: '#14b8a6', textTransform: 'uppercase', marginBottom: '24px' }}>
                  ...
                  <p style={{ fontSize: '20px', color: 'rgba(255,255,255,0.65)', maxWidth: '560px', lineHeight: 1.7, marginBottom: '48px' }}>
                  ...
                  <div style={{ display: 'flex', gap: '16px', flexWrap: 'wrap', justifyContent: 'center' }}>
                      ...
                      color: '#fff', fontWeight: 700, textDecoration: 'none', fontSize: '16px'
          }}>BOOK YOUR EXPERIENCE</a>a>
